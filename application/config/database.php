...
$db['default']['hostname'] = "steamlife.mysql.fluxflex.com";
$db['default']['username'] = "steamlife";
$db['default']['password'] = "Zt2UCCRwoaN";
...
$db['sqlite']['username'] = '';
$db['sqlite']['password'] = '';
$db['sqlite']['database'] = 'sqlite:'.APPPATH.'db/base.sqlite';
